...
<div class="hidden lg:flex h-full w-full bg-[#F8FAFC] p-6 xl:p-8">
    <div class="flex h-full w-full flex-col">
        <div class="flex-shrink-0 space-y-4 max-w-[35rem]">
            ...
            <div class="space-y-3">
                <h1 class="text-[clamp(1.625rem,2.6vw,2.5rem)] leading-[1.15] font-extrabold text-slate-950 tracking-[-0.03em] max-w-[35rem]">
                    @isset($heading)
                        {{ $heading }}
                    @else
                ...
                <p class="max-w-lg text-[0.9375rem] leading-6 text-slate-600">
        ...
        <div class="mt-4 flex-1 min-h-0 mx-auto flex w-full max-w-[35rem] flex-col items-center justify-center">
            <div class="h-full w-full min-h-0 overflow-hidden rounded-[1.75rem] shadow-sm bg-white p-4 flex items-center justify-center">
                {{--
