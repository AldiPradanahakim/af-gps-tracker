<div class="w-full max-w-[28.75rem] rounded-[1.5rem] bg-white p-5 sm:p-6 shadow-xl border border-[#E5E7EB]">
    ...
    <div class="text-center">
        ...
        <h2 class="text-[1.5rem] sm:text-[1.875rem] font-semibold tracking-[-0.03em] text-slate-950">
            Lengkapi Profil
        </h2>
    ...
    <form method="POST"
        ...
        <div>
            ...
            <div class="relative flex h-[3.25rem] items-center rounded-xl border border-slate-300 bg-white transition focus-within:border-[#2563EB] focus-within:ring-2 focus-within:ring-[#2563EB]/20">
        ...
        <button
            type="submit"
            class="flex h-[3.25rem] w-full items-center justify-center rounded-xl bg-gradient-to-r from-[#2563EB] to-[#3B82F6] text-sm font-semibold text-white shadow-lg transition hover:brightness-105">
